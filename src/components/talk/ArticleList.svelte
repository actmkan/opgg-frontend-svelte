<script lang="ts">
    ...
    import { articles, fetchArticles, pagination } from "../../store/talk";
</script>
            ...
            .article-list-paging-content {
                ...
                .article-list-paging-list {
                    ...
                    .article-list-paging-item {
                        ...
                        &.article-list-paging-item-next,
                        .article-list-paging-item-prev {
                            float: none;
                            position: relative;
                            z-index: 1;
                        }
    ...
    {#each $articles as article}
        <article class={`article-list-item ${article.is_notice ? "notice" : ""}`}>
            ...
            <div class="article-list-item-content">
                <a
                    href={`/talk/${article.talk_id}/${article.channel_id}/${article.id}`}
                    use:link
                    class="article-list-item-info">
                ...
                <ul class="article-list-paging-list">
                    {#if $pagination.currentPage > 1}
                        <li class="article-list-paging-item article-list-paging-item-prev">
                            <div
                                class="article-list-paging-button prev"
                    ...
                    {#if $pagination.currentPage < $pagination.lastPage}
                        <li
                            class="article-list-paging-item article-list-paging-item-next"
                            on:click={() => fetchArticles($pagination.currentPage + 1)}>
