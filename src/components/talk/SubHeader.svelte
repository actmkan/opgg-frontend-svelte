...
<div class="sub-header">
        ...
        <div class="sub-link">
            <ul class="sub-link-list">
                <li class="sub-link-item">
                    <div
                        class={`link-button ${$sort === "hot" ? "active" : ""}`}
                ...
                <li class="sub-link-item">
                    <div
                        class={`link-button ${$sort === "new" ? "active" : ""}`}
                ...
                <li class="sub-link-item">
                    <div
                        class={`link-button ${$sort === "top" ? "active" : ""}`}
                ...
                <li class="sub-link-item">
                    <div
                        class={`link-button ${$sort === "boost" ? "active" : ""}`}
    ...
    <div class="sub-header-search">
        <form class="sub-search">
            ...
            <input
                type="text"
                class="sub-header-search-input"
                placeholder="검색"
                bind:value={$searchText}
                on:keypress.enter={onSearch} />
            <button class="sub-header-search-button" on:click={onSearch}
                ><img
