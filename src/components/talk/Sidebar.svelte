<script lang="ts">
    ...
    import { channel, channels, setChannel, talk } from "../../store/talk";
    ...
    <div class="inner">
        <div class="content-wrap">
            <div class="content-header">
                {#if isLogin}
                    <div class="login-user">{nickname}</div>
                {:else}
                ...
                <div class="sidebar-content">
                    <div class="sidebar-menu">
                        ...
                        <ul class="sidebar-menu-list">
                            <li class="sidebar-menu-item {$channel.id === 'all' && 'active'}">
                        ...
                        <div class="sidebar-menu">
                            ...
                            <ul class="sidebar-menu-list">
                                {#each group.child as viewChannel}
                                    <li
                                        class="sidebar-menu-item {viewChannel.id === $channel.id &&
                                            'active'}">
                                        <div
                                            on:click={() =>
                                                setChannel($talk.id, viewChannel.id, "new")}>
                                            {viewChannel.display_name}
                                        </div>
                                    </li>
                                {/each}
                            </ul>
